...
public class MainActivity extends Activity implements IXListViewListener {
	...
	public static final String PHOTOS_BASE_URL = "https://api.instagram.com/v1/tags/selfie/media/recent?client_id=6a0a1beb6aad408aa0ff9bf7985c5ed5";
	...
	public void onRefresh() {
		mHandler.postDelayed(new Runnable() {
			...
			public void run() {
				...
				mAdapter = new SelfieAdapter(MainActivity.this,
						R.layout.item_flower, selfieList);
				mListView.setAdapter(mAdapter);
				onLoad();
			}
		}, 2000);
